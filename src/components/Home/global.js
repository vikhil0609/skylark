    ...
    render() {
        return (
            ...
            <div className="global-main">
                <div class="global-row global-row1">
                    <div class="global-column">
                        <div class="global-card">
                            <h3>Park Agrotech Pvt. Ltd</h3>
                            <div>
                            <img src={Ghana} />Ghana</div>
                            <p>A solution driven step to reoreint and modernize the poultry sector of Ghana was carried out after an emerging joint venture of Park Agrotech Pvt. Ltd. with Skylark Hatcheries in 2015</p>
                    ...
                    <div class="global-column">
                        <div class="global-card">
                            <h3>Skylark Sunline Company Ltd.</h3>
                            <div><img src={Myanmar} />Myanmar</div>
                            <p>A solution driven step to reoreint and modernize the poultry sector of Ghana was carried out after an emerging joint venture of Park Agrotech Pvt. Ltd. with Skylark Hatcheries in 2015</p>
                        </div>
                    </div>
                </div>

                <div class="global-row global-row2">
                    <div class="global-column">
                        <div class="global-card">
                            <h3>Premix Plant Srilanka</h3>
                            <div><img src={Srilanka} />SriLank</div>
                            <p>A solution driven step to reoreint and modernize the poultry sector of Ghana was carried out after an emerging joint venture of Park Agrotech Pvt. Ltd. with Skylark Hatcheries in 2015</p>
